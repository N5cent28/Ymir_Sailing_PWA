...
async function updateBoatStatus(boatId, status, notes = null) {
  const client = await getClient();
  try {
    await client.query(
...
async function createCheckIn(boatId, sailorName, departureTime, expectedReturn, memberNumber = null, phone = null) {
  const client = await getClient();
  try {
    const result = await client.query(
...
async function updateCheckInTime(checkInId, newReturnTime) {
  const client = await getClient();
  try {
    await client.query(
...
async function getActiveCheckIns(boatId) {
  const client = await getClient();
  try {
    const result = await client.query(
...
async function getActiveCheckInsWithBoatNames(boatId) {
  const client = await getClient();
  try {
    const result = await client.query(
...
async function getOverdueBoats() {
  const client = await getClient();
  try {
    const result = await client.query(
      `SELECT c.*, b.name as boat_name 
       FROM check_ins c 
       JOIN boats b ON c.boat_id = b.id 
       WHERE c.actual_return IS NULL AND c.expected_return < CURRENT_TIMESTAMP`
    );
    return result.rows;
  } finally {
    client.release();
...
async function createNotification(boatId, type, message) {
  const client = await getClient();
  try {
    await client.query(
...
async function cleanupOldNotifications(retentionDays = 30) {
  const client = await getClient();
  try {
    await client.query(
...
async function createMember(memberNumber, name, phone = null, email = null, isAdmin = false, pin = null) {
  const client = await getClient();
  try {
    await client.query(
...
async function isAdmin(memberNumber) {
  const client = await getClient();
  try {
    const result = await client.query(
...
async function updateCheckoutChecklist(checkInId, completed) {
  const client = await getClient();
  try {
    await client.query(
...
async function updateCheckinChecklist(checkInId, completed) {
  const client = await getClient();
  try {
    await client.query(
...
async function updateTripNotes(checkInId, notes, weatherConditions) {
  const client = await getClient();
  try {
    await client.query(
...
async function addTripPhoto(checkInId, memberNumber, photoUrl, caption = null) {
  const client = await getClient();
  try {
    const result = await client.query(
...
async function getTripPhotos(checkInId) {
  const client = await getClient();
  try {
    const result = await client.query(
...
async function likeTripPhoto(tripPhotoId, memberNumber) {
  const client = await getClient();
  try {
    await client.query(
...
async function unlikeTripPhoto(tripPhotoId, memberNumber) {
  const client = await getClient();
  try {
    await client.query(
...
async function getTripPhotoLikes(tripPhotoId) {
  const client = await getClient();
  try {
    const result = await client.query(
...
async function addTripComment(tripPhotoId, memberNumber, comment) {
  const client = await getClient();
  try {
    await client.query(
...
async function getTripComments(tripPhotoId) {
  const client = await getClient();
  try {
    const result = await client.query(
...
async function deleteTripPhoto(tripPhotoId) {
  const client = await getClient();
  try {
...
async function updateMemberProfile(memberNumber, profileData) {
  const client = await getClient();
  try {
...
async function getMemberTrips(memberNumber, limit = 10) {
  const client = await getClient();
  try {
    const result = await client.query(
      `SELECT c.*, b.name as boat_name 
...
async function sendFriendRequest(memberNumber1, memberNumber2) {
  const client = await getClient();
  try {
    await client.query(
...
async function acceptFriendRequest(memberNumber1, memberNumber2) {
  const client = await getClient();
  try {
    await client.query(
...
async function createPlannedOuting(outingData) {
  const client = await getClient();
  try {
...
async function getPlannedOutings() {
  const client = await getClient();
  try {
    const result = await client.query(
...
async function joinOuting(outingId, memberNumber) {
  const client = await getClient();
  try {
    await client.query(
...
async function getOutingParticipants(outingId) {
  const client = await getClient();
  try {
    const result = await client.query(
...
async function sendMessage(senderMemberNumber, receiverMemberNumber, message) {
  const client = await getClient();
  try {
    await client.query(
...
async function getMessages(memberNumber1, memberNumber2) {
  const client = await getClient();
  try {
    const result = await client.query(
...
async function getUnreadMessageCount(memberNumber) {
  const client = await getClient();
  try {
    const result = await client.query(
...
async function verifyMemberCredentials(memberNumber, pin) {
  const client = await getClient();
  try {
    const result = await client.query(
...
async function getMemberBoatHours(memberNumber) {
  const client = await getClient();
  try {
    const result = await client.query(
...
async function getTotalBoatHours(memberNumber) {
  const client = await getClient();
  try {
    const result = await client.query(
...
async function reportMaintenanceIssue(issueData) {
  const client = await getClient();
  try {
...
async function getMaintenanceIssues(status = null) {
  const client = await getClient();
  try {
    let query = `
...
async function getActiveMaintenanceIssues() {
  return await getMaintenanceIssues('open');
}

async function updateMaintenanceIssue(issueId, updateData) {
  const client = await getClient();
  try {
...
async function getMaintenanceIssue(issueId) {
  const client = await getClient();
  try {
    const result = await client.query(
      `SELECT mi.*, b.name as boat_name, m.name as reporter_name, 
...
async function checkInBoatForMember(boatId, memberNumber, adminMemberNumber) {
  const client = await getClient();
  try {
    // Get member details
...
async function deleteMember(memberNumber) {
  const client = await getClient();
  try {
    // Delete related data first
...
async function updateMember(memberNumber, updateData) {
  const client = await getClient();
  try {
...
async function getBoatMaintenanceHistory(boatId) {
  const client = await getClient();
  try {
    const result = await client.query(
...
async function getMemberActivity(memberNumber) {
  const client = await getClient();
  try {
    const result = await client.query(
...
async function getQRCodeByBoatId(boatId) {
  const client = await getClient();
  try {
    const result = await client.query(
...
async function createQRCode(boatId, qrCodeUrl) {
  const client = await getClient();
  try {
    const result = await client.query(
...
async function updateQRCode(boatId, qrCodeUrl) {
  const client = await getClient();
  try {
    await client.query(
...
export { acceptFriendRequest, addTripComment, addTripPhoto, checkInBoatForMember, cleanupOldMessages, cleanupOldNotifications, completeCheckIn, createCheckIn, createMember, createNotification, createPlannedOuting, createQRCode, deleteMember, deleteTripPhoto, getActiveCheckIns, getActiveCheckInsWithBoatNames, getActiveMaintenanceIssues, getAllMembers, getBoatMaintenanceHistory, getBoatStatus, getMaintenanceIssue, getMaintenanceIssues, getMemberActivity, getMemberBoatHours, getMemberByNumber, getMemberTrips, getMessages, getNotificationStats, getOutingParticipants, getOverdueBoats, getPlannedOutings, getQRCodeByBoatId, getQRCodes, getRecentNotifications, getTotalBoatHours, getTripComments, getTripPhotoLikes, getTripPhotos, getUnreadMessageCount, isAdmin, joinOuting, likeTripPhoto, markMessageAsRead, reportMaintenanceIssue, sendFriendRequest, sendMessage, unlikeTripPhoto, updateBoatStatus, updateCheckInTime, updateCheckinChecklist, updateCheckoutChecklist, updateMaintenanceIssue, updateMember, updateMemberProfile, updateQRCode, updateTripNotes, verifyMemberCredentials };
